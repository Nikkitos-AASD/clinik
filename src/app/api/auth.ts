...
export const authApi = {
  ...
  async login(credentials: LoginCredentials): Promise<LoginResponse> {
    const response = await fetch(apiClient.buildUrl('/api/login/'), {
      method: 'POST',
  ...
  async register(data: RegisterData): Promise<LoginResponse> {
    ...
    const response = await fetch(apiClient.buildUrl('/api/register/client/'), {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        phone: data.phone,
  ...
  async getCurrentUser(): Promise<User | null> {
    ...
    const response = await fetch(apiClient.buildUrl('/api/profile/me/'), {
      headers: {
  ...
  async refreshToken(): Promise<string> {
    ...
    const response = await fetch(apiClient.buildUrl('/api/token/refresh/'), {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
