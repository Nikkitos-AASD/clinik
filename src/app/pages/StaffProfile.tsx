...
export function StaffProfile() {
  ...
  useEffect(() => {
    ...
    fetch(apiClient.buildUrl('/api/profile/me/'), {
      headers: {
  ...
  const handleChangePassword = () => {
    ...
    fetch(apiClient.buildUrl('/api/auth/change-password/'), {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${token}`,
        'Content-Type': 'application/json',
  ...
  const handleSaveBooking = async () => {
    ...
    try {
      ...
      const res = await fetch(apiClient.buildUrl('/api/bookings/'), {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleUpdateBooking = async (id: number) => {
    ...
    try {
      ...
      const res = await fetch(`${apiClient.buildUrl("/api/bookings/${id}/")}`, {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
